...
namespace Drupal\cpce_profiles\Form;
...
class ImportUserFieldsForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $batch = [
      ...
      'finished' => '\Drupal\cpce_profiles\ImportFields::importUserFieldsFinishedCallback',
    ];
    foreach ($chunks as $chunk) {
      $batch['operations'][] = ['\Drupal\cpce_profiles\ImportFields::importUserFields', [$profiles, $chunk,
      [
        'max' => $num_operations,
        'chunk' => $chunk_count,
      ],
    ...
    if ($tobe_updated != NULL) {
      ...
      foreach ($update_chunks as $update_chunk) {
        $batch['operations'][] = ['\Drupal\cpce_profiles\ImportFields::updateUserFields', [$profiles, $update_chunk,
        [
