...
class GeolocationSchemaCoverageTest extends BrowserTestBase {
  ...
  public function testMapProvidersWithMapFeatures() {
    ...
    foreach ($mapProviderManager->getDefinitions() as $mapProviderId => $definition) {
      ...
      $display['display_options']['style']['options']['data_layers'] = [];
      $display['display_options']['style']['options']['data_layers']['geolocation_default_layer:default'] = [];
      $display['display_options']['style']['options']['data_layers']['geolocation_default_layer:default']['settings'] = [];
      $display['display_options']['style']['options']['data_layers']['geolocation_default_layer:default']['enabled'] = 1;
      $display['display_options']['style']['options']['data_layers']['geolocation_default_layer:default']['weight'] = 1;
      foreach ($layerFeatureManager->getLayerFeaturesByMapType($mapProviderId) as $layerFeatureId => $layerFeatureDefinition) {
        ...
        $display['display_options']['style']['options']['data_layers']['geolocation_default_layer:default']['settings']['features'][$layerFeatureId] = [
          'enabled' => TRUE,
